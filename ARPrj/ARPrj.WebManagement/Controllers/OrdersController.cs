...
namespace ARPrj.WebManagement.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,CustomerId,TotalPrice,CreateDate,UpdateDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,CustomerId,TotalPrice,CreateDate,UpdateDate")] Order order)
        {
            if (ModelState.IsValid)
            {
